...
impl Key {
    ...
    pub fn derive(
        ...
        let lbits =
            u32::try_from(size * 8).or(Err(ErrorKind::InvalidInput))?;
...
fn derive() {
    ...
    assert_eq!(
        master.0,
        vec![
            0xab, 0x4d, 0x26, 0x9f, 0xcc, 0x62, 0xbe, 0xdb, 0x45, 0x11, 0xd5,
            0x6c, 0x38, 0x6c, 0xe7, 0x06,
        ]
    )
}
...
fn mac() {
    ...
    assert_eq!(
        mac,
        [
            0xaa, 0x78, 0x55, 0xe1, 0x38, 0x39, 0xdd, 0x76, 0x7c, 0xd5, 0xda,
            0x7c, 0x1f, 0xf5, 0x03, 0x65, 0x40, 0xc9, 0x26, 0x4b, 0x7a, 0x80,
            0x30, 0x29, 0x31, 0x5e, 0x55, 0x37, 0x52, 0x87, 0xb4, 0xaf,
        ]
    )
}
